...
/**
 * Retrieve a hexa string that can be used with popchaind's CLI interface
 ...
 * * `disableMoreOutputThanInput`: disable checking if the transaction spends more popchains than the sum of the input amounts
 * @return {string}
 */
 ...
 *
 * Can receive, as output information, the output of popchaind's `listunspent` command,
 * and a slightly fancier format recognized by popcore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a popcore Address object. The
 * same is true for `script`, which can be a string or a popcore Script.
 *
 ...
 *
 * // From a pay to public key hash output from popchaind's listunspent
 ...
 *
 * @see {https://github.com/popchain/bips/blob/master/bip-0069.mediawiki}
 * @return {Transaction} this
 */
 ...
 * CheckTransaction in popchain core.
 */
...
/**
 * Analogous to popchaind's IsCoinBase function in transaction.h
 */
